...
export function renderIconSVG(key: string | null): string {
  ...
  if (!body) return ''
  return `<svg class="cm-txn-desc-icon" width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true">${body}</svg>`
}
