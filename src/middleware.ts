...
export const config = {
  matcher: [
    '/((?!api/auth|api/internal|api/admin|api/version|login|privacy|terms|learn|logo|icon|apple-icon|manifest|web-app-manifest|_next/static|_next/image|favicon.ico).*)',
  ],
}
