...
await page.getByText('Choose an issuer').click()
await page.waitForTimeout(400)
await page.getByRole('option', { name: 'Axis Bank' }).click()
await page.waitForTimeout(1500)
// tick a couple of cards
for (const n of ['Axis Atlas', 'Axis Magnus Burgundy']) {
  try { await page.getByText(n, { exact: true }).click(); await page.waitForTimeout(300) } catch {}
}
await page.waitForTimeout(500)
await page.screenshot({ path: '/tmp/addcard-multi.png' })
await browser.close()
