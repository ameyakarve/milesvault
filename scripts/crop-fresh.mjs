...
writeFileSync('/tmp/ref-bottom2.png', PNG.sync.write(crop(refPng, 380, 2280, 1880, 110)))
writeFileSync('/tmp/mine-bottom2.png', PNG.sync.write(crop(minePng, 380, 540, 1880, 110)))
