...
const info = await page.evaluate(() => {
  ...
  const firstCard = document.querySelector('.cm-line.cm-card-active')
  const fr = firstCard.getBoundingClientRect()
  return { contentLeft: ce.left, contentPadLeft: ccs.paddingLeft, cardLeft: fr.left, cardWidth: fr.width }
})
console.log(info)
await browser.close()
