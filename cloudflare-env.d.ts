/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface CloudflareEnv cloudflare-env.d.ts` (hash: 7618011ac9f2812b1d02d9856ca95317)
...
declare namespace Cloudflare {
	interface GlobalProps {
		...
		durableNamespaces: "LedgerDO" | "ChatAgent" | "ThinkAgent";
	}
	interface StagingEnv {
		...
		ChatAgent: DurableObjectNamespace<import("./.open-next/worker").ChatAgent>;
