/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface CloudflareEnv cloudflare-env.d.ts` (hash: 3cac36f92997fbf01ae0eb98ec53961f)
// Runtime types generated with workerd@1.20260504.1 2026-05-13 global_fetch_strictly_public,nodejs_compat
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./.open-next/worker");
		durableNamespaces: "LedgerDO" | "ChatDO" | "ConciergeDO" | "MembershipDO" | "AirportsDO" | "UsageDO";
	}
	interface StagingEnv {
		...
		CHAT_DO: DurableObjectNamespace<import("./.open-next/worker").ChatDO>;
		CONCIERGE_DO: DurableObjectNamespace<import("./.open-next/worker").ConciergeDO>;
		MEMBERSHIP_DO: DurableObjectNamespace<import("./.open-next/worker").MembershipDO>;
		AIRPORTS_DO: DurableObjectNamespace<import("./.open-next/worker").AirportsDO>;
		...
		REFRESH_MAGNIFY: Workflow<Parameters<import("./.open-next/worker").RefreshMagnifyWorkflow['run']>[0]['payload']>;
	}
	interface Env {
		R2: R2Bucket;
		D1: D1Database;
		...
		ENABLE_HYDRATE?: "1";
		AI_GATEWAY_ID: "milesvault-staging" | "milesvault";
		INGEST_EMAIL_ADDRESS: "ingest-staging@milesvault.com" | "ingest@milesvault.com";
		AUTH_GOOGLE_ID: string;
		AUTH_GOOGLE_SECRET: string;
		AUTH_SECRET: string;
		CLOUDFLARE_ACCOUNT_ID: string;
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "APP_ENV" | "ENABLE_HYDRATE" | "AI_GATEWAY_ID" | "INGEST_EMAIL_ADDRESS" | "AUTH_GOOGLE_ID" | "AUTH_GOOGLE_SECRET" | "AUTH_SECRET" | "CLOUDFLARE_ACCOUNT_ID" | "AERODATABOX_API_KEY" | "TEST_USER_TOKEN">> {}
}
